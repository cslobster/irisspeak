  ...
  return (
    <div className="relative min-h-screen overflow-hidden" style={{ background: '#f0ebe1' }}>
      <div className="min-h-screen px-8 py-10 max-w-3xl mx-auto flex flex-col items-center">
        ...
        <div className="bg-white border-2 border-[#94c1c2] rounded-3xl px-8 py-6 flex flex-col items-center gap-3 mb-8 shadow w-full max-w-md">
          {!submitted ? (
            <>
              ...
              <div className="flex gap-2">
                {[1, 2, 3, 4, 5].map(s => (
                  ...
                  >
                    <StarIcon size={52} fill={(hovered || 0) >= s || (rating || 0) >= s ? '#f09281' : '#e2e8f0'} stroke="#000" strokeWidth={16} shadow />
                  </button>
                ))}
              </div>
            </>
            ...
            <>
              ...
              <div className="flex gap-2">
                {[1, 2, 3, 4, 5].map(s => (
                  <StarIcon key={s} size={44} fill={(rating || 0) >= s ? '#f09281' : '#e2e8f0'} stroke="#000" strokeWidth={16} shadow />
                ))}
              </div>
