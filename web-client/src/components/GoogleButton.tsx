...
export function GoogleButton({ href, disabled }: { href: string; disabled?: boolean }) {
  return (
    <a href={disabled ? undefined : href} aria-disabled={disabled}
      className="flex items-center justify-center gap-2 w-full whitespace-nowrap rounded-xl px-3 py-3 text-[15px] font-bold text-slate-700 bg-white border-2 border-slate-200 hover:border-slate-400 transition"
